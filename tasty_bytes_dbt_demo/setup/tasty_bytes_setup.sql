...
GRANT USAGE ON SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
GRANT CREATE TABLE ON SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
GRANT CREATE VIEW ON SCHEMA TASTY_BYTES_DBT_DB.DEV TO ROLE DEMO_ROLE;
